...
class AttackCarliniWagnerL2:
    ...
    def __init__(self, targeted=True, search_steps=None, max_steps=None, cuda=True, num_classes=10, confidence=0, clip_min=-1, clip_max=1, learning_rate=1e-2, debug=False):
        self.debug = debug
